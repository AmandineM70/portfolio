 ...
 * Demo import
 */
if ( ! function_exists( 'sambailey_demo_import_files' ) ) {
	function sambailey_demo_import_files() {
		return array(
			array(
				'import_file_name' => esc_html__( 'Demo Import', 'sam-bailey' ),
				'local_import_file' => SAMBAILEY_REQUIRE_DIRECTORY . 'inc/demo/demo-content.xml',
				'local_import_widget_file' => SAMBAILEY_REQUIRE_DIRECTORY . 'inc/demo/widgets.wie',
				'local_import_customizer_file' => SAMBAILEY_REQUIRE_DIRECTORY . 'inc/demo/customizer.dat'
			),
		);
	}
}
add_filter( 'pt-ocdi/import_files', 'sambailey_demo_import_files' );
 ...
 */
if ( ! function_exists( 'sambailey_after_import_setup' ) ) {
	function sambailey_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'sambailey_after_import_setup' );