...
namespace {
    ...
    class InstallerBootstrapData {
        const ARCHIVE_FILENAME       = '20240110_artdemangel_6105ef0d827075973294_20240110152950_archive.zip';
        const ARCHIVE_SIZE           = '226858441';
        const INSTALLER_DIR_NAME     = 'dup-installer';
        const PACKAGE_HASH           = '6105ef0-10152950';
        const SECONDARY_PACKAGE_HASH = '203556a-10152950';
